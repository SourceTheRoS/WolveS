-----------------------------------------------
-- This Source Was Developed By (WolveS) @oggoo.--
--   This Is The Source Channel @oggoo .   --
--                - WolveS-                 --
--        -- https://t.me/oggoo --         --
------------------------------------------------ 
...
local Text ='*↫ تم اختيار الاغنية بشكل عشوائي*'

local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/N2N222/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "متحركه" then
Abs = math.random(2,140); 
local Text ='*تم اختيار المتحركه بشكل عشوائي*'
...
if text == "شعر" then
Abs = math.random(2,140); 
local Text ='*↫ تم اختيار الشعࢪ بشكل عشوائي*'
...
if text == "ميمز" then
Abs = math.random(2,140); 
local Text ='*↫ تم اختيار الميمز بشكل عشوائي*'
...
Abs = math.random(2,140); 
local Text ='*↫ تم اختيار الريمكس بشكل عشوائي*'
...
Abs = math.random(2,140); 
local Text ='*↫ تم اختيار الريماكس بشكل عشوائي*'
...
Abs = math.random(2,140); 
local Text ='*↫ تم اختيار الانمي بشكل عشوائي*'
...
Abs = math.random(2,140); 
local Text ='*↫ تم اختيار صوࢪه عشوائيه لك*'
...
local UserId_Info = LuaTele.searchPublicChat("oggoo")
...
keyboardd.inline_keyboard = {
{
{text = '❲ 𝖼𝗈𝖽𝖾𝗋 ❳', url = "https://t.me/oggoo"}
},
{
{text = '❲ WolveS ❳', url = "https://t.me/nnn_e"},
},
...
local m = "https://t.me/O7O777"..Rrr..""
local rep = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id="..msg_chat_id.."&caption="..URL.escape(t).."&photo="..m.."&reply_to_message_id="..rep.."&parse_mode=Markdown")
end
if text == 'السورس' or text == 'سورس' or text == 'يا سورس' or text == 'source' then
photo = "https://t.me/nnn_e"
local T =[[  ]]
keyboard = {} 
...
if text == 'هلا' or text == 'هاي ' or text == 'مس' then
if not Redis:get(TheWolveS.."WolveS:Sasa:Jeka"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end

return LuaTele.sendText(msg_chat_id,msg_id,'*نوࢪت وࢪده*',"md",false, false, false, false, reply_markup)
end
...
if text == 'نتعرف؟' or text == '،نتعرف' or text == 'نتعرف' then 
if not Redis:get(TheWolveS.."WolveS:Sasa:Jeka"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end

return LuaTele.sendText(msg_chat_id,msg_id,'*امـشي وخࢪ مـنـا يدوࢪ تعارف ️*',"md",false, false, false, false, reply_markup)
end

if text == 'لتزحف' or text == 'زاحف' or text == 'لتحتك' then
if not Redis:get(TheWolveS.."WolveS:Sasa:Jeka"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end

return LuaTele.sendText(msg_chat_id,msg_id,'*شـعليڪ بـي عمࢪيي خـلي يـزحف ️*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*زاحـف ع خـالـتڪ شـڪࢪه ️*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*ويـنـه بـلـه خـل حـصـࢪه*',"md",false, false, false, false, reply_markup)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*عـساس انـي مـيـت بيڪڪ دمـشـي لڪ*',"md",false, false, false, false, reply_markup)
end
...
if text == 'انجب' or text == 'نجبي' or text == 'نجب' then
if not Redis:get(TheWolveS.."WolveS:Sasa:Jeka"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'*سـؤال صـعـب خلـيـني افڪࢪ',"md",false, false, false, false, reply_markup)
end
if text == 'تحديث' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*᥀︙هاذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
...
if text == (Redis:get(TheWolveS.."WolveS:Name:Bot") or "الذئاب") then
local NamesBot = (Redis:get(TheWolveS.."WolveS:Name:Bot") or "الذئاب")
local NameBots = {
"تـفضل واختــصࢪ؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
"لتــلح دا احجي ويه بنات الذئاب بعدين اجاوبك",
"خـاب وصخـونه بڪلبك شࢪايد",
"يمعـود توني نمت",
}
...
local NamesBot = (Redis:get(TheWolveS.."WolveS:Name:Bot") or "الذئاب")
local BotName = {
"اسمع لك اذا تـ؏ـيدها مال بوت اطردك خوش؟ ",
"خاب ومࢪض هياتني مطايࢪ",
"هـا يـ؏ـيونـي 🥲🤍",
}
...
if Redis:get(TheWolveS.."WolveS:Status:Games"..msg.chat_id) then
local texting = {"الـ¹@ كلهه لش متحبني؟",
...
local CmdStart = '*\n᥀︙ اهلا بيك عزيزي اني اسمي '..(Redis:get(TheWolveS.."WolveS:Name:Bot") or "الذئاب")..
'\n᥀︙وضيفتي حمايه الكروبات ومميزات خدميه اخرى'..
'\n᥀︙للبدء ارفعني مشرف في كروبك وارسل تفعيل ...'..
'\n᥀︙وشوف الازرار لكي ترا قناه السورس والمطور والخ'
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
{text = '‹ قناة السورس ›', url = 't.me/nnn_e'},{text = '‹ لتنصيب بوت ›', url = 't.me/oggoo'}, 
},
{
...
data = {
{
{text = '‹ قناه السورس ›', url = 't.me/nnn_e'},{text = '‹ لتنصيب بوت ›', url = 't.me/oggoo'}, 
},
{
{text = '‹ اضفني الى مجموعتك ›', url = 't.me/'..UserBot..'?startgroup=new'}, 
},
...
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. ChatId .. '&voice=https://t.me/N2N222/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
LuaTele.deleteMessages(ChatId,{[1]= Msg_id})
end
end
