...
if text == 'تحميل' or text == 'التحميل' then
...
data = {
{
{text = '‹ بوت تحميل من التيك توك›', url = 't.me/R0OBOT'},{text = '‹ بوت تحميل من الانستگرام ›', url = 't.me/V0OBOT'}, 
},
{
{text = '‹ بوت تحميل من اليوتيوب ›', url = 't.me/D9OBOT'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id,'*❲ اليك بوتات تحميل من المواقع ❳*',"md",false, false, false, false, reply_markup)
end
